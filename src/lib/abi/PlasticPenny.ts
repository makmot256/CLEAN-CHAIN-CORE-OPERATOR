// PlasticPenny Token ABI
export const PlasticPennyABI = [
  { "type": "constructor", "inputs": [{ "name": "initialSupply", "type": "uint256", "internalType": "uint256" }], "stateMutability": "nonpayable" },
...
export default PlasticPennyABI;
